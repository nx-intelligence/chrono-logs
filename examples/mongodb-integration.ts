import { createXLogger } from 'xronolox';
import type { LoggerPackageConfig, XLoggerConfig } from 'xronolox';

// MongoDB Integration Example
// This example shows how to configure xronolox with MongoDB using Chronos-DB v2.0
